...
CREATE TABLE "CustomerMrr" (
    ...
    CONSTRAINT "CustomerMrr_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CustomerMrr_customerId_month_key" ON "CustomerMrr"("customerId", "month");
...
-- AddForeignKey
ALTER TABLE "CustomerMrr" ADD CONSTRAINT "CustomerMrr_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Customer"("id") ON DELETE CASCADE ON UPDATE CASCADE;
